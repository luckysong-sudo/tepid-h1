...
DIMENSIONS: tuple[StatusDimension, ...] = (
    ...
    StatusDimension(
        ...
        evidence=(
            ...
            "generation sampling controls reject boolean, non-numeric and non-finite values",
            "attention cache loading and updates validate tensor shape, length and dtype",
        ),
        gaps=(
    ...
    StatusDimension(
        ...
        evidence=(
            ...
            "stage-gate CLI evidence references are parser-validated without executing gates",
            ...
            "ONNX export validates opset version before invoking the exporter",
